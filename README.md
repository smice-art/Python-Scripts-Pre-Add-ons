<p align="center">
  <img src="main/pre-addon.jpg" alt="pre-addon" width="100%">
</p>
...
## Installation
Note: Please download the file located under the Assets section of the latest Releases page, or the "Download ZIP" button on the main page.
